from PyQt5.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QListWidget, QListWidgetItem, QComboBox
...
class IndicatorManagerDialog(QDialog):
    ...
    def refresh_list(self):
        ...
        for indicator in self.indicator_config:
            item = QListWidgetItem(f"{indicator['type']}({indicator['period']}) на оси {indicator['axis']}")
    ...
    def add_indicator(self):
        ...
        self.indicator_config.append({"type": ind_type, "period": period, "axis": axis})
        self.refresh_list()
